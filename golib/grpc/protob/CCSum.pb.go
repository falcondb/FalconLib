...
func (*EchoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee4da9672572473c, []int{0}
}
...
func (*EchoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee4da9672572473c, []int{1}
}
...
func init() {
	proto.RegisterType((*EchoRequest)(nil), "golib.grpc.protob.EchoRequest")
	proto.RegisterType((*EchoResponse)(nil), "golib.grpc.protob.EchoResponse")
}

func init() { proto.RegisterFile("CCSum.proto", fileDescriptor_ee4da9672572473c) }

var fileDescriptor_ee4da9672572473c = []byte{
	// 197 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *echoClient) UnaryEcho(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/golib.grpc.protob.Echo/UnaryEcho", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *echoClient) ServerStreamingEcho(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (Echo_ServerStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[0], "/golib.grpc.protob.Echo/ServerStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoClient) ClientStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_ClientStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[1], "/golib.grpc.protob.Echo/ClientStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoClient) BidirectionalStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_BidirectionalStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[2], "/golib.grpc.protob.Echo/BidirectionalStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func _Echo_UnaryEcho_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/golib.grpc.protob.Echo/UnaryEcho",
	}
...
var _Echo_serviceDesc = grpc.ServiceDesc{
	ServiceName: "golib.grpc.protob.Echo",
